...
export const About = props => {
  return (
    <div
      id="about"
      className={props.about ? "modal show" : "modal"}
      style={{ height: "auto" }}
    >
      <img src={awoo} alt="" />
      <h1>Lee.js</h1>
      ...
      <span>
        ...
        Node {process.versions.node}, Lee {pjson.version} running on{" "}
        {process.env.os}
      </span>
      <br />
      <span>
        Plays every format you throw at it, including the most obscure ones. UI
        designed with modern web technologies of today.<br />Media playback
        powered by mpv.js and Chrome
      </span>
      <br />
      ...
      <div className="space" />
      <button
        onClick={e => document.getElementById("about").classList.remove("show")}
        className="button"
      >
        Close
      </button>
...
export const Shaders = props => {
  return (
    <div id="shaders" className={props.shaders ? "modal show" : "modal"}>
      ...
      <button
        onClick={e =>
          document.getElementById("shaders").classList.remove("show")}
        className="button"
      >
        Close
      </button>
...
export const OpenURL = props => {
  return (
    <div
      id="openurl"
      className={props.openUrl ? "modal show" : "modal"}
      style={{ height: "auto" }}
    >
      <h1>Open Web URL</h1>
      ...
      <Grid fluid className="modalGrid">
        <Row className="modalRow">
          ...
          />
          <button onClick={props.loadURL} className="button">
      ...
      <button
        onClick={e =>
          document.getElementById("openurl").classList.remove("show")}
        className="button"
      >
        Close
      </button>
