            ...
            ? <div id="media">
                <ReactPlayer
                  ...
                  onError={e => {
                    ...
                    this.setState({
                      errorOn: true,
                      errorMsg: e.path[0].attributes.src.value
                    });
                  }}
                  ...
                  <div className="controls-flex">
                    <button className="control" onClick={this.togglePause}>
                      <i className="material-icons">
                        {this.state.pause ? "play_arrow" : "pause"}
                      </i>
                    </button>
                    <input
                      className="seek"
                    ...
                    />
                    <button className="control" onClick={this.toggleFullscreen}>
