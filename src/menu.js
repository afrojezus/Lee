...
export default class Menu extends Component {
  ...
  _toggledev = () => {
    electron.remote.getCurrentWebContents().isDevToolsOpened()
    ...
    electron.remote.dialog.showOpenDialog(
      {
        ...
        filters: [
          {
            name: "Video",
            extensions: ["mkv", "avi", "mp4", "webm"]
          },
          {
            name: "Audio",
            extensions: ["mp3", "flac", "ogg", "wav", "aac", "alac", "m4a"]
          }
        ],
        properties: ["openFile"]
      },
      ...
      <div className="appbar">
        <div className="appbar-flex">
          <div className="appbarMenu">
            <div className="appbarButton" onClick={this._openMenu}>
              <img src={menuSvg} alt="" />
            </div>
